  ...
  return (
    <>
      <div className='bg-sky-700 py-16 flex flex-col md:px-4 justify-between items-center px-5 space-y-4 w-full'>
        ...
        <form action="" className='flex flex-col items-center justify-between gap-4 w-full md:w-2/5'>
          <input type="text" placeholder="Enter your email to sign up" className='px-3 py-2 rounded-sm w-full' />
          <button className='px-3 py-2 rounded-sm bg-sky-950 hover:bg-sky-500 text-white font-bold w-full'>Subscribe</button>
        </form>
      </div>
