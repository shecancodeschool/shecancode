                ...
                <div className='flex w-full flex-wrap justify-between'>
                    <div className="flex-1 w-full md:w-[65%] mb-12 md:pr-8 text-black">
                        ...
                        <section class="section">
                            <h3>Introduction</h3>
                            <p>SheCanCODE Bootcamp understands that your privacy is important to you and that we care about how your personal data is used. We respect and value the privacy of all our customers and users and we will only collect and use personal data in ways that are described here and in a way that is consistent with our obligations and your rights under the Data Protection legislation.</p>
                            <p>This is SheCanCODE Privacy Notice (“Privacy Notice”) which may be accessed from <a href="https://www.shecancodeschool.org/">https://www.shecancodeschool.org/</a> where you submit personal data to access the service or may be obtained as a hard copy when you submit personal data at our medical laboratory.</p>
                        </section>
                        ...
                        <section class="section">
                            <h3>What does this Privacy Notice Cover?</h3>
                            <p>This Privacy Notice explains how we use your personal data: how it is collected, how it is held, and how it is processed. It also explains your rights under the law relating to your data.</p>
                        </section>
                        ...
                        <section class="section">
                            <h3>Contact Us</h3>
                            <p>If you wish to contact us in respect of part of this Privacy Notice, have any questions or would like further information regarding our handling of your data, please contact us by email:</p>
                            <div class="contact-info">
                        ...
                        <section class="section">
                            ...
                            <p>We may change, modify, or adopt a new Privacy Notice from time to time. If we do so, we will post it on our website and our social media platforms. You must check the Privacy Notice every time you submit your data to us. This version was last updated on Tuesday 1st April 2024.</p>
                        </section>
                    </div>
